    ...
    <>
      ...
      <section className="movie flex flex-col gap-x-5 md:gap-x-9 lg:gap-x-12 w-full max-w-[1536px]  mx-auto mt-9 px-5 pb-5 sm:max-2xl:px-[5vw]">
        <main className="movie__main flex flex-col gap-y-8 w-full lg:w-[73%] xl:w-[79%] 2xl:w-[83%] ">
          <MovieList title="Trending" redirect="trending" movies={trending} loading={loading} />
          <MovieList title="Popular" redirect="popular" movies={popular} loading={loading} />
          <MovieList title="Upcoming" redirect="upcoming" movies={upcoming} loading={loading} />
        </main>
